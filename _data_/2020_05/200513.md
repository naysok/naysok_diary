...
昨日、調べた SDF (Signed Distance Fields) についての本を Booth で買ってみたり、コンピュータグラフィックスとは何ぞや的なサイトを見たりする。  

最近よく話している気がするが、高度な “Additive Manufacturing” には、従来の CAD では対応できず、CG の技術を頑張っていくしかないが、とても難しい根ということをよく話している。  

といっても、画面に描画するための技術と、3D のデータを書き出すのはまた別だと思うので、少しずつ取り組んでいきたい。  
