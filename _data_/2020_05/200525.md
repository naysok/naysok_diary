...
気合でモジュール化を押し進める。長いパッケージ名や長いモジュール名の読み込みが多くなったり、それぞれでの reload() での再読み込みが多くなったりでつらくなってきたので、__init__.py を調べる。なんとなく読み込みのあれというのは知っていたので、調べて書いてみる。確認用に dir() を使って洗い出すのが調子よかった。  

ライノのためのモジュール、プロジェクトごと、都度都度バラバラになっていく気がするがどこかに最新俺ラッパーまとめを作っておくべきかと迷うかも。  
