...
<p>昼に起きた。gcode 生成を書く。正確な仕様がわからず、きちんと動いているパスを精査するしかないので、やはり苦労する。動いているパスのコマンドをぐぐって意味を調べ確認しながら、プログラムに反映する。途中で大きなミスに気がついたが、ここまでの実装が困るほど汚くは無いので、すばやく復旧。  </p>

<p>週末だったので、早め早めのつもりで、洗濯や掃除、布団とシーツの洗濯など。  </p>
