...
<p>gcode リファクタリングの作業に取り掛かる。2年前に書いていたプログラムを開くと、予想はしていたが、ぐちゃぐちゃで絶望する。ほぼ全部書き直し。  </p>

<p>200415 にいくつか行った、ghPython, ghCPython のテストの結果、挙動としては ghPython ですべて書いてしまうのが良さそう。Python 2系で書かなければなら無いので要確認。  </p>

<p>設計は見えてきているが、プログラムは特に進んでいない。  </p>
