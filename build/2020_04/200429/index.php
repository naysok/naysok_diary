...
<p>PHP を書いたり、昨日の仕事の続きをしたり、キッチンの掃除をしたり、一日が終わる。  </p>

<p>gcode を見続け、パースし続け、心が折れる。gcode より一段階扱いやすい中間文字列があったら便利なんじゃないかと思う。古い規格だったり、一般的にはこれでいいと考えられていたりするものでも、場合によってはもっと便利にしたいときがある。使ったことは無いので適当な知識で書くが、CSS にはメタ言語があるので、それにより CSS では出来ないネストが出来るようになっているはず。  </p>

<h3>diary-updete, month</h3>

<p>PHP で書いている diary.naysok.org のアップデート。日数毎のページが各行に並び、どんどん下に長くなったので、月ごとの括りに変更。データも月ごとのフォルダ毎をつくり、その中に 1 - 31日まで入れていこうと思う。地味な文字列処理がいくつか出てきたの、だらだら書いた。  </p>

<p>この後の残し作業として、md から php 変換の Python を修正が必要。  </p>
