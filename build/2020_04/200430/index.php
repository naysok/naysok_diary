...
<p>Windows 10 のマシンに環境を整える。  </p>

<p>Rhinoceros の Cloud Zoo を使うと、1つのライセンスを、複数のパソコンで使いまわせるのを確認。  </p>

<p>激重 Visual Studio のインストール。cs で書かれたアプリケーションのビルドができた。中身のソースを確認して、発生するエラーの原因を探した。ついでに、必要なアドオンの中身なども確認して、あれこれテスト、結果は良好。  </p>
