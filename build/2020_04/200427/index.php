...
<p>がちゃがちゃやりつつ、整理して、整理することで見えた改善点を改善するなど、3歩進んでは2歩下がって、みたいな進捗である。しかしながら、ぼちぼち亜修正が入るであろうものを、整理せずに前だけに進むのは怖いので、これが正攻法と信じたい。  </p>

<p>作業中に、予備校のノリで学ぶ大学数学という、YouTube チャンネルを見る。こういう機会の度に数学をきちんとやっておけば良かった、ちょっとずつでも勉強しよう的な気持ちが高まる。一時的には高まるが、すぐに冷めてしまう、理由を見つけ後回しにしてしまうので、この性格は良くないなと思う。  </p>
