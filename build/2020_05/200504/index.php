...
<p>Windows 10 のマシンに、環境を整える作業の続き。  </p>

<p>併せて、ディスプレイをチェック。Dell の IPS 液晶と、BenQ の TN 液晶の色再現率を比較。TN 液晶の白に飛ぶ感じが耐えられず、Dell の IPS 液晶を探して注文。  </p>

<p>最近書いているプログラムを修正。いくつかの基本的な関数も結構整ってきた気がする。もう少し。  </p>

<h3>gcode リファクタリング（Rhino + Python）</h3>

<p>ある程度、完成に近づいてきて、こまごまとした修正を施す。こまごまとした修正に合わせて、少しずつ機能が複雑になってきた。  </p>

<p>機能が複雑になるにつれ、引数（設定項目）が増えてくる。引数が多い関数はオシャレではない気もするが、引数をまとめて渡したとしても設定項目が減るわけではないので、とりあえずこのまま続きを書いている。    </p>
