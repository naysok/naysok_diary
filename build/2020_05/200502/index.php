...
<p>コメントアウトされ要素が無い行や、XY だけ、もしくは Z だけの行などがあるので、その行に要素がなければ、直前の行の要素を拾って入れるという実装にした。本当はコメントアウト行などを飛ばせばいいのだが、プレビューの際に何行目に何が起きてるかを把握するにはこうするしかない気もするのでいったんこれで。  </p>
