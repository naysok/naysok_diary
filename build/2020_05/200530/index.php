...
<p>昨日、ジオメトリとして綺麗にと消そうとわかっていたものを実装する。  </p>

<p>実装は、VPL で始めたので、VPL で書き進めていたが、途中で Python コンポーネント挟んだり、気合のデータツリー処理で何とか着地。  </p>

<p>綺麗に解けているので、構造的に意味のある形を目指し、パラメータの細かなチューニングを行っていく。パラメータで手修正することを想定して作っておいたのが功を奏し、まあうまくいきそうな気配はある。  </p>
