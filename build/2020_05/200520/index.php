...
<p>今日も今日とて、ライノの自動処理を調べて試してを繰り返している。コンポーネント内に直書きで進めると Undo、Redo などで重い処理が走ってしまい大変なので、モジュール化を進めようと思う。  </p>

<p>昼に散歩に出たら、近所のスポーツ用品店が営業していて、ノリでトレーニングウェアを買った。フットサルのウェアを打っているメーカーの謎に派手なデザインが気になる。    </p>

<p>日没後、ランニングに出るも、調子に乗って結構遠くまで行ってしまい、帰りはへろへろ。2時間くらい。全身砕けそうになった。  </p>
