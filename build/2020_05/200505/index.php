...
<p>USB 延長ケーブル、USB ハブ、細めのイーサネットケーブル、イヤホンジャック延長ケーブル、適切な長さの DP ケーブル、雷ガード電源タップなどを買う。即急には要らないが、700W まで対応の細い電源ケーブルを買いたい。  </p>

<p>gcode パーサについて、配列の中で要素が前後で重複した場合は消してひとつにまとめるようにした。あればうれしい機能がそろってきている気がするのでもう少し続けていきたい。  </p>
