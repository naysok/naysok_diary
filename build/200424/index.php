...
<p>寝坊した。マーチングキューブの実装について考える。マーチングキューブは、格子点（ここでは、ボクセルも同義とする）からメッシュを貼る手法だと思う。  </p>

<p>良く考えてみると、似たような概念として扱われる？、メタボールとの詳細な関係について調べる必要があると思った。メタボールでは入力の点から格子点を計算し、そこからマーチングキューブによる出力がいる（という認識をしている）ので、マーチングキューブのほうが下位の概念であるのかなと思う。まずは、2次元で実装してみようと思う。Rhino でやろうと思うが、挙動がわかりやすい ghPython = Python2 でやるか、若干不便な ghCPython = Python3 でやるか検討の余地有り。  </p>
